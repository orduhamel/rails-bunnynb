...
cannelle = Bunny.new(name: 'cannelle', description: 'cannelle aime le calme et les caresses. Elle n\'est pas compatible avec les chiens.', address: 'Nantes', price_per_day: 15, fur: 'moelleux', skill: 'relaxant', weight: 'léger', size: 'moyen', cleanliness: 4)
...
vanille = Bunny.new(name: 'Vanille', description: 'Vanille est une lapine sportive. Elle aime les parcours d\'obstacles.', address: 'Saint-Herblain', price_per_day: 17, fur: 'soft', skill: 'acrobate', weight: 'normal', size: 'petit', cleanliness: 5)
...
lexie = Bunny.new(name: 'Lexie', description: 'Lexie aime jouer et supporte très bien la compagnie des autres animaux.', address: 'Rezé', price_per_day: 17, fur: 'moelleux', skill: 'relaxant', weight: 'normal', size: 'nain', cleanliness: 4)
...
pistache = Bunny.new(name: 'Pistache', description: 'Pistache est un lapin qui aime faire la fête. Il est toujours partant pour aller boire un verre avec ses copains lapins', address: 'Nantes', price_per_day: 13, fur: 'rêche', skill: 'fêtard', weight: 'normal', size: 'moyen', cleanliness: 5)
...
arya = Bunny.new(name: 'Arya', description: 'Arya est très peureuse. Elle aime beacoup les calins.', address: 'Saint-Sebastien', price_per_day: 14, fur: 'doux', skill: 'câlin', weight: 'léger', size: 'nain', cleanliness: 3)
...
choco = Bunny.new(name: 'Choco', description: 'Choco est un lapin qui aime plaire, il saura vous faire un charme.', address: 'Rezé', price_per_day: 16, fur: 'doux', skill: 'reproducteur', weight: 'lourd', size: 'large', cleanliness: 2)
...
coco = Bunny.new(name: 'Coco', description: 'Coco a le caractère d\'un lapin et la taille d\'un chien, il vous permet d\'avoir un bon compromis.', address: 'Nantes', price_per_day: 12, fur: 'rêche', skill: 'boxer', weight: 'énorme', size: 'géant', cleanliness: 5)
...
lulu = Bunny.new(name: 'Lulu', description: 'Lulu n\'apprécie pas la compagnie des autres animaux, elle passe l\'essentiel de son temps à dormir.', address: 'Saint-Herblain', price_per_day: 15, fur: 'doux', skill: 'boxer', weight: 'léger', size: 'petit', cleanliness: 4)
...
paris = Bunny.new(name: 'Paris', description: 'Paris est un lapin voyageur, il vous accompagnera avec plaisir pendant vos vacances.', address: 'Saint-Sebastien', price_per_day: 16, fur: 'doux', skill: 'relaxant', weight: 'normal', size: 'moyen', cleanliness: 3)
...
couscous = Bunny.new(name: 'Couscous', description: 'Couscous aime manger et faire des câlins.', address: 'Nantes', price_per_day: 16 , fur: 'moelleux', skill: 'câlin', weight: 'lourd', size: 'grand', cleanliness: 4)
