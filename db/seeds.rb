...
lulu = Bunny.new(name: 'Lulu', description: 'Lulu n\'apprécie par la compagnie des autres animaux, elle passe l\'essentiel de son temps à dormir.', address: 'Saint-Herblain', price_per_day: 15, fur: 'doux', skill: 'boxer', weight: 'léger', size: 'petit', cleanliness: 4)
